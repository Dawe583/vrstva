  ...
  return (
    <section id="sluzby" className="py-16 md:py-24">
      <div className="mx-auto max-w-[1400px] px-6 md:px-10">
        <Reveal>
          <h2 className="max-w-[16ch] font-display text-4xl font-medium tracking-tighter md:text-6xl">
            Od první skici po spuštění.
          </h2>
        </Reveal>
          ...
          <Reveal className="md:col-span-7">
            <article className="group relative h-full min-h-[320px] overflow-hidden md:min-h-[420px]">
              <img
                ...
                loading="lazy"
                className="absolute inset-0 h-full w-full object-cover grayscale-[0.4] transition-transform duration-700 group-hover:scale-105"
              />
